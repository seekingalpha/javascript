...
Install ESlint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install babel-eslint@10.1.0 eslint@7.8.0 eslint-plugin-flowtype@5.2.0 eslint-plugin-jest@23.20.0 eslint-plugin-jsx-a11y@6.3.1 eslint-plugin-react@7.20.6 eslint-plugin-react-hooks@4.1.0 --save-dev

or **Yarn**:

    yarn add --dev babel-eslint@10.1.0 eslint@7.8.0 eslint-plugin-flowtype@5.2.0 eslint-plugin-jest@23.20.0 eslint-plugin-jsx-a11y@6.3.1 eslint-plugin-react@7.20.6 eslint-plugin-react-hooks@4.1.0
