...
Install ESlint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install babel-eslint@10.0.3 eslint@6.8.0 eslint-plugin-flowtype@4.6.0 eslint-plugin-jest@23.6.0 eslint-plugin-jsx-a11y@6.2.3 eslint-plugin-react@7.18.0 eslint-plugin-react-hooks@2.3.0 --save-dev

or **Yarn**:

    yarn add --dev babel-eslint@10.0.3 eslint@6.8.0 eslint-plugin-flowtype@4.6.0 eslint-plugin-jest@23.6.0 eslint-plugin-jsx-a11y@6.2.3 eslint-plugin-react@7.18.0 eslint-plugin-react-hooks@2.3.0
