...
Install ESlint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install babel-eslint@10.0.2 eslint@6.2.1 eslint-plugin-flowtype@4.2.0 eslint-plugin-jest@22.15.2 eslint-plugin-jsx-a11y@6.2.3 eslint-plugin-react@7.14.3 eslint-plugin-react-hooks@2.0.1 --save-dev

or **Yarn**:

    yarn add --dev babel-eslint@10.0.2 eslint@6.2.1 eslint-plugin-flowtype@4.2.0 eslint-plugin-jest@22.15.2 eslint-plugin-jsx-a11y@6.2.3 eslint-plugin-react@7.13.3 eslint-plugin-react-hooks@2.0.1
