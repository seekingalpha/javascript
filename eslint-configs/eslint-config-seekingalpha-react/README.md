...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/):
    ...
    npm install eslint@8.14.0 eslint-plugin-flowtype@8.0.3 eslint-plugin-jsx-a11y@6.5.1 eslint-plugin-react@7.29.4 eslint-plugin-react-hooks@4.4.0 --save-dev
