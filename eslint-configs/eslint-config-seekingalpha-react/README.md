...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/):
    ...
    npm install eslint@8.20.0 eslint-plugin-flowtype@8.0.3 eslint-plugin-jsx-a11y@6.6.0 eslint-plugin-react@7.30.1 eslint-plugin-react-hooks@4.6.0 --save-dev
