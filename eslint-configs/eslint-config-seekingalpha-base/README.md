...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/):
    ...
    npm install eslint@8.52.0 eslint-plugin-array-func@4.0.0 eslint-plugin-import@2.28.1 eslint-plugin-no-use-extend-native@0.5.0 eslint-plugin-promise@6.1.1 eslint-plugin-unicorn@48.0.1 --save-dev
