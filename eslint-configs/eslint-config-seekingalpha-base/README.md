...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/):
    ...
    npm install eslint@7.31.0 eslint-plugin-array-func@3.1.7 eslint-plugin-import@2.23.4 eslint-plugin-no-use-extend-native@0.5.0 eslint-plugin-promise@5.1.0 eslint-plugin-unicorn@34.0.1 --save-dev
