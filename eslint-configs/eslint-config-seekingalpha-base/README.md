...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install eslint@6.8.0 eslint-plugin-array-func@3.1.4 eslint-plugin-import@2.20.1 eslint-plugin-jsdoc@21.0.0 eslint-plugin-no-use-extend-native@0.4.1 eslint-plugin-promise@4.2.1 eslint-plugin-unicorn@16.1.1 --save-dev

or **Yarn**:

    yarn add --dev eslint@6.8.0 eslint-plugin-array-func@3.1.4 eslint-plugin-import@2.20.1 eslint-plugin-jsdoc@21.0.0 eslint-plugin-no-use-extend-native@0.4.1 eslint-plugin-promise@4.2.1 eslint-plugin-unicorn@16.1.1
