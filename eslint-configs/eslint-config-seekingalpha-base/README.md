...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install eslint@7.8.0 eslint-plugin-array-func@3.1.7 eslint-plugin-import@2.22.0 eslint-plugin-no-use-extend-native@0.5.0 eslint-plugin-promise@4.2.1 eslint-plugin-unicorn@21.0.0 --save-dev

or **Yarn**:

    yarn add --dev eslint@7.8.0 eslint-plugin-array-func@3.1.7 eslint-plugin-import@2.22.0 eslint-plugin-no-use-extend-native@0.5.0 eslint-plugin-promise@4.2.1 eslint-plugin-unicorn@21.0.0
