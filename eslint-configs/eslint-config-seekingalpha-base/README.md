...
Install ESlint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install eslint@5.16.0 eslint-plugin-array-func@3.1.3 eslint-plugin-import@2.17.3 eslint-plugin-jsdoc@8.1.0 eslint-plugin-no-use-extend-native@0.4.1 eslint-plugin-promise@4.2.1 eslint-plugin-unicorn@9.1.1 --save-dev

or **Yarn**:

    yarn add --dev eslint@5.16.0 eslint-plugin-array-func@3.1.3 eslint-plugin-import@2.17.3 eslint-plugin-jsdoc@8.1.0 eslint-plugin-no-use-extend-native@0.4.1 eslint-plugin-promise@4.2.1 eslint-plugin-unicorn@9.1.1
