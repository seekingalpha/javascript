...
Install ESlint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install eslint@6.4.0 eslint-plugin-protractor@2.1.1 eslint-plugin-mocha@6.1.1 --save-dev

or **Yarn**:

    yarn add --dev eslint@6.4.0 eslint-plugin-protractor@2.1.1 eslint-plugin-mocha@6.1.1
