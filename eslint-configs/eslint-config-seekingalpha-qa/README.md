...
Install ESLint and all [Peer Dependencies](https://nodejs.org/en/blog/npm/peer-dependencies/) with **NPM**:
    ...
    npm install eslint@7.9.0 eslint-plugin-protractor@2.1.1 eslint-plugin-mocha@8.0.0 --save-dev

or **Yarn**:

    yarn add --dev eslint@7.9.0 eslint-plugin-protractor@2.1.1 eslint-plugin-mocha@8.0.0
